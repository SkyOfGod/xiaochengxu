...
public class JdResult {
    ...
    public static JdResult build(Integer code, String msg) {
        return new JdResult(code, msg, null);
    }

    public static JdResult build(Integer code) {
        return new JdResult(code, "", null);
    }
